...
# Deploying to Coolify - Kenya School of Government ATS

This guide provides instructions for deploying the Kenya School of Government Applicant Tracking System to Coolify with Supabase integration.

## Prerequisites

1. A Coolify instance running on a server
2. A domain name (optional, but recommended)
3. SSH access to your server
4. Git repository access for your project
5. Your Supabase project credentials

## Step 1: Set Up Your Server

If you don't already have a server with Coolify installed:

1. Provision a server (Ubuntu 20.04 LTS or newer recommended)
...
Before deploying your application, ensure your Supabase project is ready:

1. Log in to your Supabase dashboard
2. Note your project URL and anon key (found in Project Settings > API)
3. Ensure you have run all the SQL migrations in your Supabase project (check the SQL files in this repository)
...
2. Test the application to ensure all functionality works correctly:
   ...
   - Confirm you can apply for jobs
   - Test the admin interface (requires login)
